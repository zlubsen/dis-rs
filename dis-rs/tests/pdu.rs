use bytes::BytesMut;
use dis_rs::{DisError, enumerations::{PduType, SignalEncodingClass, SignalEncodingType}, model::{Pdu, PduBody, PduHeader}, signal::model::{EncodingScheme, Signal}};
use nom::AsBytes;
...
fn test_insufficient_buffer_capacity() {
    ...
    assert_eq!(serialisation_result,
               Err(DisError::InsufficientBufferSize(pdu.pdu_length(), SOME_SMALL_AMOUNT_OF_BYTES)))
}
