...
mod tests {
    ...
    fn parse_multiple_headers() {
        let bytes: [u8; 24] = [
            0x06, 0x01, 0x01, 0x01, 0x4e, 0xea, 0x3b, 0x60, 0x00, 0x0c, 0x00, 0x00, 06, 0x01, 0x01,
    ...
    fn parse_multiple_headers_1st_too_short() {
        let bytes: [u8; 23] = [
            0x06, 0x01, 0x01, 0x01, 0x4e, 0xea, 0x3b, 0x60, 0x00, 0x0c, 0x00, 06, 0x01, 0x01, 0x01,
            0x4e, 0xea, 0x3b, 0x60, 0x00, 0x0c, 0x00, 0x00,
        ];
