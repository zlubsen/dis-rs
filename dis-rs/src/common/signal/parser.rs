...
use crate::enumerations::{SignalEncodingClass, SignalEncodingType};
use crate::{SignalTdlType, SignalUserProtocolIdentificationNumber};
...
fn parse_encoding_scheme(encoding_scheme_bytes: u16, data: &[u8]) -> EncodingScheme {
    ...
    match encoding_class {
        ...
        SignalEncodingClass::RawBinaryData => {
            EncodingScheme::RawBinaryData { encoding_class, nr_of_messages: low_bits }
        }
