use crate::enumerations::{
    AirPlatformCapabilities, CulturalFeatureCapabilities, EntityCapabilities, EntityKind,
    EnvironmentalCapabilities, ExpendableCapabilities, LandPlatformCapabilities,
    LifeFormsCapabilities, MunitionCapabilities, PlatformDomain, RadioCapabilities,
...
pub fn entity_capabilities_from_bytes(
    ...
    match (entity_type.kind, entity_type.domain) {
        ...
        (EntityKind::Munition, _) => {
            EntityCapabilities::MunitionEntityCapabilities(MunitionCapabilities::from(capabilities))
        }
        (EntityKind::LifeForm, _) => EntityCapabilities::LifeFormsEntityCapabilities(
            LifeFormsCapabilities::from(capabilities),
        ),
        (EntityKind::Environmental, _) => EntityCapabilities::EnvironmentalEntityCapabilities(
            EnvironmentalCapabilities::from(capabilities),
        ),
        (EntityKind::CulturalFeature, _) => EntityCapabilities::CulturalFeatureEntityCapabilities(
            CulturalFeatureCapabilities::from(capabilities),
        ),
        (EntityKind::Supply, _) => {
            EntityCapabilities::SupplyEntityCapabilities(SupplyCapabilities::from(capabilities))
        }
        (EntityKind::Radio, _) => {
            EntityCapabilities::RadioEntityCapabilities(RadioCapabilities::from(capabilities))
        }
        (EntityKind::Expendable, _) => EntityCapabilities::ExpendableEntityCapabilities(
            ExpendableCapabilities::from(capabilities),
        ),
        (EntityKind::SensorEmitter, _) => EntityCapabilities::SensorEmitterEntityCapabilities(
            SensorEmitterCapabilities::from(capabilities),
        ),
