...
mod pre_processing {
    ...
    fn process_enum_bitfield(
        ...
        let (field_type, field_type_fqn) = match (field.size, &field.enum_uid) {
            ...
            (_, Some(uids)) => {
                ...
                (
                    ty,
                    syn::parse_str(field_type).expect("Expected a valid Enum Type"),
                )
            }
            (None, None) => {
    ...
    fn process_fixed_record(
        ...
        crate::generation::FixedRecord {
            fields: record
                ...
                .collect(),
            record_type: syn::parse_str(&formatted_record_type)
                .expect("Expected a valid FixedRecord Type"),
            record_type_fqn: syn::parse_str(lookup_fqn(&formatted_record_type, lookup))
                .expect("Expected a valid FQN FixedRecord Type"),
    ...
    fn process_bit_record(
        ...
        crate::generation::BitRecord {
            fields: record
                ...
                .collect(),
            record_type: syn::parse_str(&formatted_record_type)
                .expect("Expected a valid BitRecord Type"),
            record_type_fqn: syn::parse_str(lookup_fqn(&formatted_record_type, lookup))
                .expect("Expected a valid FQN BitRecord Type"),
            size: record.size,
        }
    }
    ...
    fn process_adaptive_record(
        ...
        crate::generation::AdaptiveRecord {
            variants: record
                ...
                .collect(),
            record_type: syn::parse_str(&formatted_record_type)
                .expect("Expected a valid AdaptiveRecord Type"),
            record_type_fqn: syn::parse_str(lookup_fqn(&formatted_record_type, lookup))
                .expect("Expected a valid FQN AdaptiveRecord Type"),
            length: record.length,
    ...
    fn process_extension_record(
        ...
        crate::generation::ExtensionRecord {
            ...
            record_name_fqn: syn::parse_str(lookup_fqn(&formatted_record_name, lookup))
                .expect("Expected a valid FQN ExtensionRecord Type"),
    ...
    #[allow(dead_code)]
    fn process_padding_16() -> crate::generation::PaddingTo16 {
        crate::generation::PaddingTo16
    }

    #[allow(dead_code)]
    fn process_padding_32() -> crate::generation::PaddingTo32 {
        crate::generation::PaddingTo32
    }

    fn process_padding_64() -> crate::generation::PaddingTo64 {
    ...
    fn process_pdu_fixed_record_fields_enum(
        ...
        lookup: &Lookup,
    ) -> crate::generation::PduAndFixedRecordFieldsEnum {
        match e {
            crate::extraction::PduAndFixedRecordFieldsEnum::Numeric(f) => {
                crate::generation::PduAndFixedRecordFieldsEnum::Numeric(process_numeric_field(f))
            }
            crate::extraction::PduAndFixedRecordFieldsEnum::Enum(f) => {
                crate::generation::PduAndFixedRecordFieldsEnum::Enum(process_enum_field(f, lookup))
            }
            crate::extraction::PduAndFixedRecordFieldsEnum::FixedString(f) => {
                crate::generation::PduAndFixedRecordFieldsEnum::FixedString(
                    process_fixed_string_field(f),
                )
            }
            crate::extraction::PduAndFixedRecordFieldsEnum::FixedRecord(f) => {
                crate::generation::PduAndFixedRecordFieldsEnum::FixedRecord(
                    process_fixed_record_field(f, lookup),
                )
            }
            crate::extraction::PduAndFixedRecordFieldsEnum::BitRecord(f) => {
                crate::generation::PduAndFixedRecordFieldsEnum::BitRecord(process_bit_record_field(
                    f, lookup,
                ))
            }
            crate::extraction::PduAndFixedRecordFieldsEnum::AdaptiveRecord(f) => {
                crate::generation::PduAndFixedRecordFieldsEnum::AdaptiveRecord(
    ...
    fn process_extension_record_field_enum(
        ...
        lookup: &Lookup,
    ) -> crate::generation::ExtensionRecordFieldEnum {
        match e {
            crate::extraction::ExtensionRecordFieldEnum::Numeric(f) => {
                crate::generation::ExtensionRecordFieldEnum::Numeric(process_numeric_field(f))
            }
            crate::extraction::ExtensionRecordFieldEnum::Enum(f) => {
                crate::generation::ExtensionRecordFieldEnum::Enum(process_enum_field(f, lookup))
            }
            crate::extraction::ExtensionRecordFieldEnum::FixedString(f) => {
                crate::generation::ExtensionRecordFieldEnum::FixedString(
                    process_fixed_string_field(f),
                )
            }
            crate::extraction::ExtensionRecordFieldEnum::VariableString(f) => {
                crate::generation::ExtensionRecordFieldEnum::VariableString(
                    process_variable_string(f),
                )
            }
            crate::extraction::ExtensionRecordFieldEnum::FixedRecord(f) => {
                crate::generation::ExtensionRecordFieldEnum::FixedRecord(
                    process_fixed_record_field(f, lookup),
                )
            }
            crate::extraction::ExtensionRecordFieldEnum::BitRecord(f) => {
                crate::generation::ExtensionRecordFieldEnum::BitRecord(process_bit_record_field(
                    f, lookup,
                ))
            }
            crate::extraction::ExtensionRecordFieldEnum::Array(f) => {
                crate::generation::ExtensionRecordFieldEnum::Array(process_array(f, lookup))
            }
            crate::extraction::ExtensionRecordFieldEnum::AdaptiveRecord(f) => {
                crate::generation::ExtensionRecordFieldEnum::AdaptiveRecord(
                    process_adaptive_record_field(f, lookup),
                )
            }
            crate::extraction::ExtensionRecordFieldEnum::Opaque(f) => {
                crate::generation::ExtensionRecordFieldEnum::Opaque(process_opaque_data(f))
            }
            crate::extraction::ExtensionRecordFieldEnum::PaddingTo16 => {
                crate::generation::ExtensionRecordFieldEnum::PaddingTo16
            }
            crate::extraction::ExtensionRecordFieldEnum::PaddingTo32 => {
                crate::generation::ExtensionRecordFieldEnum::PaddingTo32
            }
        }
    }
    ...
    fn process_bit_record_field_enum(
        ...
        lookup: &Lookup,
    ) -> crate::generation::BitRecordFieldEnum {
        match e {
            crate::extraction::BitRecordFieldEnum::Enum(f) => {
                crate::generation::BitRecordFieldEnum::Enum(process_enum_bitfield(f, lookup))
            }
            crate::extraction::BitRecordFieldEnum::Int(f) => {
                crate::generation::BitRecordFieldEnum::Int(process_int_bitfield(f))
            }
            crate::extraction::BitRecordFieldEnum::Bool(f) => {
                crate::generation::BitRecordFieldEnum::Bool(process_bool_bitfield(f))
            }
        }
    }
    ...
    fn process_adaptive_format_enum(
        ...
        lookup: &Lookup,
    ) -> crate::generation::AdaptiveFormatEnum {
        match e {
            crate::extraction::AdaptiveFormatEnum::Numeric(f) => {
                crate::generation::AdaptiveFormatEnum::Numeric(process_numeric_field(f))
            }
            crate::extraction::AdaptiveFormatEnum::Enum(f) => {
                crate::generation::AdaptiveFormatEnum::Enum(process_enum_field(f, lookup))
            }
            crate::extraction::AdaptiveFormatEnum::FixedString(f) => {
                crate::generation::AdaptiveFormatEnum::FixedString(process_fixed_string_field(f))
            }
            crate::extraction::AdaptiveFormatEnum::FixedRecord(f) => {
                crate::generation::AdaptiveFormatEnum::FixedRecord(process_fixed_record_field(
                    f, lookup,
                ))
            }
            crate::extraction::AdaptiveFormatEnum::BitRecord(f) => {
                crate::generation::AdaptiveFormatEnum::BitRecord(process_bit_record_field(
                    f, lookup,
                ))
            }
        }
    ...
    fn process_array_field_enum(
        ...
        lookup: &Lookup,
    ) -> crate::generation::ArrayFieldEnum {
        match e {
            crate::extraction::ArrayFieldEnum::Numeric(f) => {
                crate::generation::ArrayFieldEnum::Numeric(process_numeric_field(f))
            }
            crate::extraction::ArrayFieldEnum::Enum(f) => {
                crate::generation::ArrayFieldEnum::Enum(process_enum_field(f, lookup))
            }
            crate::extraction::ArrayFieldEnum::FixedString(f) => {
                crate::generation::ArrayFieldEnum::FixedString(process_fixed_string_field(f))
            }
            crate::extraction::ArrayFieldEnum::FixedRecord(f) => {
                crate::generation::ArrayFieldEnum::FixedRecord(process_fixed_record_field(
                    f, lookup,
                ))
            }
            crate::extraction::ArrayFieldEnum::BitRecord(f) => {
                crate::generation::ArrayFieldEnum::BitRecord(process_bit_record_field(f, lookup))
            }
        }
    }
