...
mod tests {
    ...
    #[test]
    fn parse_collision() {
        let input = [0b00_000000, 0b0001_0000, 0b000001_00, 0b00000001, 0b_00000000, 0b10_000000, 0b0010_0000, 0b000010_00, 0b00000001, 0b_00000000, 0b01_000000, 0b0011_0_000, 0b0000001_0, 0b00000000, 0b1_0000000, 0b001_00011, 0b00100_000, 0b0000001_0, 0b00000000, 0b1_0000000, 0b001_00000];
        ...
        if let CdisBody::Collision(collision) = body {
            ...
            assert_eq!(collision.units.location_entity_coordinates, UnitsMeters::Centimeter);
            assert_eq!(collision.issuing_entity_id, EntityId::new(UVINT16::from(1), UVINT16::from(1), UVINT16::from(1)));
            assert_eq!(collision.colliding_entity_id, EntityId::new(UVINT16::from(2), UVINT16::from(2), UVINT16::from(2)));
            assert_eq!(collision.event_id, EntityId::new(UVINT16::from(1), UVINT16::from(1), UVINT16::from(3)));
